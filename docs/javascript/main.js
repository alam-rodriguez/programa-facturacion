...
if( categories != null ){
    ...
    } else secition1.innerHTML += `<p class="parrafo">No hay ninguna categoria, dirijase a <span><a href="crearCategorias.html">'Categorias'</a></span> para crear una categoria.</p>`;
}else {
    secition1.innerHTML += `<p class="parrafo">No hay ninguna categoria, dirijase a <span><a href="crearCategorias.html">'Categorias'</a></span> para crear una categoria.</p>`;
}
...
if( articulos != null ){
    ...
    }else secition1.innerHTML += `<p class="parrafo">No hay ningun articulo, dirijase a <span><a href="creararticulos.html">'articulos'</a></span> para crear su primer articulo.</p>`;
}else{
    secition1.innerHTML += `<p class="parrafo">No hay ningun articulo, dirijase a <span><a href="creararticulos.html">'articulos'</a></span> para crear su primer articulo.</p>`;
}
...
const datosDelCliente = () =>{
        ...
        // divNuevoCliente.classList.remove('list-clientes-display-true');
        // divClientes.classList.add('list-clientes-display-true');
        document.querySelector('.nuevo-cliente-info #nombre-de-cliente').value = '';
        document.querySelector('.nuevo-cliente-info #numero-de-cliente').value = '';
        document.querySelector('.nuevo-cliente-info #dirrecion-de-cliente').value = '';
        document.querySelector('.nuevo-cliente-info #nota').value = '';
...
btnCobrar.addEventListener('click',(e)=>{
    ...
    // document.querySelector('main').classList.add('main-display-none');
...
let btnAtrasCobra = document.querySelector('#atras-cobrar');
    ...
    pedidoCliente.forEach((pedido)=> {
        ...
        // document.querySelector('main').classList.remove('main-display-none');
